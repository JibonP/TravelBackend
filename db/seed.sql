...
INSERT INTO destinations (name, location, image_url) VALUES
  ...
  ('Cairo', 'Egypt', 'https://www.traveloffpath.com/wp-content/uploads/2023/05/Cairo-Pyramids-Egypt.jpg');
...
INSERT INTO reviews (user_id, destination_id, content, rating) VALUES
  ...
  (1, 4, 'Cairo is good place to travel to see the wonder of the world.', 5);
